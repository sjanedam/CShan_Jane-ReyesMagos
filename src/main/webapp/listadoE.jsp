	...
	<div class="container mt-3">
		...
		<div class="d-flex flex-row-reverse">
			<div class="p-2">
				...
				<div class="modal fade buscarEventos" tabindex="-1" role="dialog"
						...
						<div class="modal-content">
							...
							<div class="container formulario">
								...
								<form action="ServletForm" method="post">
									<div class="mb-3 mt-3">
										<label for="buscarEvento">Código del evento: </label> <input
											type="text" class="form-control" id="buscarEvento"
											placeholder="Introduce el código del evento (5 dígitos)"
											name="buscarEvento" required pattern="[0-9]{5}">
									</div>
		...
		<!-- TABLA -->
		<h3 style='color: #215F78;'>¡Conoce los eventos!</h3>
		<table class="table">
			<thead style='color: #FFC023;'>
				<tr>
					<th scope="col">Código_evento</th>
			...
			<tbody>
				...
				for (int i = 0; i < lista.size(); i++) {
					...
					out.println("<td style='font-weight: bold;'>" + lista.get(i).getUbicacion() + "</td>");
					out.println("<td style='font-weight: bold;'>" + lista.get(i).getFecha() + "</td>");
					out.println("<td>" + lista.get(i).getHora() + "</td>");
					out.println("<td>" + lista.get(i).getCod_grupo() + "</td>");
					out.println("</tr>");
				}
				%>
			</tbody>
