...
<body>
	<div class="container p-3 d-flex justify-content-center">
		...
		<a href="index.html" class="btn btn-warning b1" style="margin-left: 10px;">
			...
			Barrios barrio = (Barrios) misesion.getAttribute("barrio");
				
				// BARRIO //
			  if (barrio != null){
				out.println("<div class='container mt-3'>");
					out.println("<h1 style='color: #215F78;'>Información del barrio:</h1>");
					out.println("<table class='table'>");
						out.println("<thead style='color: #FFC023;'>");
							out.println("<tr>");
								out.println("<th scope='col'>Código</th>");
								out.println("<th scope='col'>Nombre</th>");
								out.println("<th scope='col'>Zona</th>");
							out.println("</tr>");
						out.println("</thead>");
						
						out.println("<tbody>");
							out.println("<tr>");
								out.println("<td>" + barrio.getCodigo() + "</td>");
								out.println("<td style='font-weight: bold;'>" + barrio.getNombre() + "</td>");
								out.println("<td style='font-weight: bold;'>" + barrio.getZona() + "</td>");
							out.println("</tr>");
						out.println("</tbody>");
					out.println("</table>");
				out.println("</div>");
